...
# docker build -t vectors_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name vectors_app vectors_app
...
RUN groupadd --system --gid 1000 rails && \
    useradd rails --uid 1000 --gid 1000 --create-pages --shell /bin/bash && \
